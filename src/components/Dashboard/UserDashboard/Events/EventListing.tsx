        ...
        <div className="">
            ...
            <div className="mt-4 p-4 border-l-4 rounded-md bg-gray-100 dark:bg-primary-foreground border-yellow-500 text-gray-900 dark:text-gray-100">
                <div className="flex italic items-center gap-2">
                    ...
                    <p className="text-sm">
                        <strong>Note:</strong> Events are created by alumni or
                        faculty but are not institution-verified. Verify details
                        before attending and report suspicious activities. Avoid
